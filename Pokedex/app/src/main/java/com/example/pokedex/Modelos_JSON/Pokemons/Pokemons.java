...
package com.example.pokedex.Modelos_JSON.Pokemons;
...
public class Pokemons implements Serializable {
     ...
     * @param results
     */
    public Pokemons(Integer count, String next, Object previous, List<Result> results) {
        super();
        this.count = count;
        this.next = next;
    ...
    public String toString() {
        ...
        sb.append(Pokemons.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("count");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pokemons) == false) {
            return false;
        }
        Pokemons rhs = ((Pokemons) other);
